 ...
 */
package org.rappsilber.gui.components.CSV;
...
import org.rappsilber.gui.components.ColumnHeaderClickHandler;
import org.rappsilber.gui.components.GenericJTablePopUpMenu;
...
public class CSVPanel extends javax.swing.JPanel {
    ...
    private class CSVListTableModel extends AbstractTableModel implements CSVRandomAccess.LoadListener {
        ...
        public int getRowCount() {
            ...
            return (m_editable ?  Math.max(m_rowcount,20)+1 : m_rowcount);
        }
        ...
        public int getColumnCount() {
            ...
            return m_editable ? Math.max(m_columcount,20)+1 : m_columcount;
        }
...
//    ArrayList<String[]> m_csvData = new ArrayList<String[]>();
    ...
    public void setEditable(boolean m_editable) {
        ...
        if (m_editable) {
            ...
            m_popup.installContextMenu(tblCSV,true,true);
        } else {
            m_popup.removeContextMenu(tblCSV);
            m_popup.installContextMenu(tblCSV,true,false);
...
//        }
    ...
    public void csvChanged()  {
        TableModel tm = tblCSV.getModel();
        if (tm instanceof CSVListTableModel)
